...
import {Sidebar, SidebarMenu,SidebarRoute,SidebarIcon,SidebarText} from './SidebarElement';
const SellerIndex = ({titleOne,titleTwo,titleThree,titleFour,titleFive,iconOne,iconTwo,iconThree,iconFour,iconFive,linkOne,linkTwo,linkThree,linkFour,linkFive}) => {
    return (
       <Sidebar>
           <SidebarMenu>
